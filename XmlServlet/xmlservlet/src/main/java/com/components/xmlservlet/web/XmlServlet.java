...
import com.components.xmlservlet.service.XmlDispatcherService;
...
public class XmlServlet extends FrameworkServlet {
	...
	private XmlDispatcherService service;
	private XmlConverter converter;

	@Autowired
	public XmlServlet(final XmlDispatcherService service, final XmlConverter converter) {
